...
1. Click the Laika toolbar icon to toggle the attached sidecar panel in the current tab (scoped to the current Safari window). If the sidecar can’t attach, Laika opens the UI as a standalone panel window.
