...
1. Click the Laika toolbar icon to toggle the attached sidecar panel in the current tab. If the sidecar can’t attach, Laika opens the UI as a standalone panel window.
