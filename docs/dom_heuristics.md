...
Laika's "browser as workshop" workflow (see `docs/LaikaArch.md` and `src/laika/PLAN.md`) collects many sources, then queries/transforms them (comparison tables, timelines) and opens results in new viewer tabs.
